...
async function main() {
  ...
  const consultorio1 = await prisma.professional.create({
    data: {
      ...
      photoUrl: "/delta-assets/ig-post-consultorio.jpg",
    },
  });
  ...
  const consultorio2 = await prisma.professional.create({
    data: {
      ...
      photoUrl: "/delta-assets/ig-post-consultorio-infantil.jpg",
    },
  });
