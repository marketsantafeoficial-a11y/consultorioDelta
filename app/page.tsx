...
export const metadata = {
  ...
  description:
    "Consultorios para profesionales de la salud en City Bell. Psicología, salud integral, turnos por WhatsApp y alquiler de espacios por módulo.",
};

const SPECIALTIES = [
  { id: "psicologia", label: "Psicología", desc: "Acompañamiento emocional, procesos personales, ansiedad, autoestima, duelos y vínculos." },
  { id: "psicopedagogia", label: "Psicopedagogía", desc: "Procesos de aprendizaje, orientación y acompañamiento personalizado." },
  { id: "terapia-ocupacional", label: "Terapia ocupacional", desc: "Autonomía, bienestar y calidad de vida a través de actividades significativas." },
  { id: "nutricion", label: "Nutrición", desc: "Hábitos saludables, alimentación consciente y bienestar integral." },
  { id: "optometria", label: "Optometría", desc: "Evaluación, prevención y cuidado de la salud visual." },
    ...
    <div className="lp-shell">
      ...
      <main>
        <section className="lp-hero lp-hero-showcase">
          <div className="lp-hero-copy">
            ...
            <h1 className="lp-hero-title">Espacios donde los encuentros acompañan el cambio.</h1>
            <p className="lp-hero-sub">
              En Delta encontrarás profesionales de distintas disciplinas que comparten el compromiso de brindar atención y asesoramiento inmediato para tus necesidades. Conocé sus perfiles y contactate de manera directa para coordinar una consulta.
            </p>
            <p className="lp-hero-note">Atención únicamente con cita previa coordinada por WhatsApp.</p>
            ...
            <div className="dual-cta-grid">
              <RevealOnScroll>
                <article className="soft-cta-card">
                  <h2>¿Buscás un profesional para acompañarte?</h2>
                  <p>Encontrá el profesional indicado y coordiná tu consulta de manera directa.</p>
                  <Link href="/profesionales#derivacion" className="lp-cta-primary"><CalendarIcon />Reservar turno</Link>
                </article>
              </RevealOnScroll>
              <RevealOnScroll delay={120}>
                <article className="soft-cta-card">
                  <h2>¿Buscás un espacio para atender?</h2>
                  <p>Sumate a nuestro equipo de profesionales y empezá a trabajar con nosotros.</p>
                  <a
                    href={getWhatsAppHref("¡Hola! Quiero consultar por alquilar un módulo en Delta.")}
                    className="lp-cta-primary"
                    target="_blank"
                    rel="noreferrer"
                  >
                    <CalendarIcon />Alquilar módulo
                  </a>
                </article>
              </RevealOnScroll>
            </div>
          ...
          <div className="lp-section-inner">
            ...
            <RevealOnScroll delay={120}>
              <div className="quienes-somos-text">
                <p>Delta es un espacio profesional ubicado en el centro de City Bell. Desde 2023 reunimos distintas disciplinas en un entorno cálido, cómodo y funcional. Pensamos cada detalle para ofrecer un lugar agradable tanto para profesionales como para quienes llegan en busca de atención y acompañamiento.</p>
                <p>En nuestro espacio trabajan profesionales de diferentes áreas, generando una comunidad basada en el respeto, la cercanía y el compromiso con cada persona que nos elige, de acuerdo a su necesidad.</p>
        ...
        <section id="especialidades" className="lp-section lp-how">
          <div className="lp-section-inner">
            ...
            <RevealOnScroll delay={100}>
              <p className="lp-section-sub">Conocé las disciplinas que forman parte de nuestra red profesional.</p>
            </RevealOnScroll>
        ...
        <section id="red-profesionales" className="lp-section">
          <div className="lp-section-inner">
            ...
            <RevealOnScroll delay={120}>
              <p className="lp-section-sub">Conocé los profesionales que forman parte de nuestro espacio. Podés comunicarte directamente por WhatsApp desde cada perfil.</p>
            </RevealOnScroll>
            <div className="lp-feature-row">
              ...
              <article>
                <h3>Atención con cita previa</h3>
                <p>Trabajamos exclusivamente con turnos programados previamente. Conocé los perfiles profesionales y contactate directamente por WhatsApp para coordinar tu consulta, resolver dudas o recibir más información.</p>
        ...
        <section id="alquila-espacio" className="lp-section">
          <div className="lp-section-inner">
            <RevealOnScroll>
              <DrawTitle tag="h2" className="lp-section-title">Alquilá tu espacio</DrawTitle>
            </RevealOnScroll>
            <RevealOnScroll delay={100}>
              <p className="lp-section-sub">¿Buscás un espacio listo para atender? Este lugar es ideal para vos. En Delta contamos con consultorios totalmente equipados, ideales para profesionales que deseen trabajar en un espacio cómodo, luminoso y bien ubicado.</p>
            </RevealOnScroll>
            <div className="rental-detail-grid rental-detail-grid-wide">
              <article>
                <h3>El espacio cuenta con</h3>
                <p>WiFi, sala de espera, baño, cocina, AA frío/calor, escritorio, diván y portero individual. No contamos con secretaría.</p>
              </article>
              <article>
                <h3>Modalidad de alquiler</h3>
                <p>Se alquilan por módulos fijos o jornada completa. El valor se adapta según la cantidad de módulos que necesites.</p>
              </article>
              <article>
            ...
            <RevealOnScroll delay={180}>
              <div className="schedules-section">
                ...
                <p className="schedules-subtitle">Hacé clic en cada consultorio para ver los módulos disponibles u ocupados.</p>
                <div className="fixed-modules-summary">
                  <span className="fixed-modules-eyebrow">Disponibilidad por módulos fijos</span>
                  <div className="fixed-modules-grid">
                    {FIXED_MODULES.map(([label, hours]) => (
                      <article key={label}>
                        ...
                        <span className="fixed-modules-tag">Módulo fijo</span>
                      </article>
                    ))}
                  </div>
                </div>
        ...
        <section id="contacto" className="lp-section">
          <div className="lp-section-inner">
            ...
            <RevealOnScroll delay={80}>
              <p className="lp-section-sub">Lunes a sábados de 9 a 20 hs.</p>
            </RevealOnScroll>
            <RevealOnScroll delay={120}>
      ...
      <footer className="lp-footer">
        <div className="lp-footer-inner">
          <div>
            <img src="/delta-logo-round.jpeg" alt="Delta Espacios Profesionales" className="footer-logo" />
          </div>
